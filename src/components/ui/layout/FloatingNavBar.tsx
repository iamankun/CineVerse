...
export const FloatingNavBar: React.FC = () => {
    ...
    // Xác định màu dựa trên route - QUAN TRỌNG: Kiểm tra chính xác
    const getThemeColor = () => {
        // Điện Ảnh: màu cyan (#06b6d4) cho route /movie
        if (pathname?.startsWith('/movie')) {
            return 'cyan';
        }
        // Chương trình TV: màu orange (#e67e22) cho route /tv  
        if (pathname?.startsWith('/tv')) {
            return 'orange';
        }
        // Mặc định: màu orange cho trang chủ và các trang khác
        return 'orange';
    };
    ...
    return (
        <>
            ...
            <nav className="floating-nav-bar" data-theme={themeColor}>
                ...
                <NavItem path="/tivi" label="Trực tiếp">
